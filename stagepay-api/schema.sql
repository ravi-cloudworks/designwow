...
CREATE TABLE IF NOT EXISTS redirect_links (
  ...
  -- Opt-in, off by default — once on, the customer pay page shows this
  -- project's click stats as soon as Stage 5 has an amount set (not only
  -- once paid/locked, which would freeze the project first).
